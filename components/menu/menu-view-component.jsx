...
export function MenuViewComponent({ items, timeSlotNames, internalTimeSlots, displayTimeSlots }) {
    const [activeSlotIndex, setActiveSlotIndex] = useState(0);
    const [selectedCategory, setSelectedCategory] = useState("All");

    const activeSlot = internalTimeSlots[activeSlotIndex];
    const activeSlotDisplay = displayTimeSlots[activeSlotIndex];
    ...
    return (
        <div className="flex flex-col h-full gap-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500">Browse and view all menu items</p>
            </div>
